...
public class MovieRecord extends Item {
    ...
    public MovieRecord(String id, String title, Enum.RentalType rentalType, Enum.LoanType loanType, int numCopies, double rentalFee, boolean rentalStatus, Enum.Genre genre) {
